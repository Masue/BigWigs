...
function BigWigsKelThuzad:BigWigs_RecvSync(sync, rest, nick)
	if sync == "KelFrostboltInterrupt" and self.db.profile.frostbolt then
		self:TriggerEvent("BigWigs_StartBar", self, L["frostbolt_bar"], 0, "")
	elseif sync == "KelDetonate" and rest and self.db.profile.detonate then
